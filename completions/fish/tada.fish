...
complete -c tada -n "__fish_seen_subcommand_from build" -s p -rf -a "debug release" -d "Build profile"
...
complete -c tada -n "__fish_seen_subcommand_from cache" -s f -d "Overwrite cache"
...
complete -c tada -n "__fish_seen_subcommand_from init" -l name -rf -d "Package name"
complete -c tada -n "__fish_seen_subcommand_from init" -s n -rf -d "Package name"
complete -c tada -n "__fish_seen_subcommand_from init" -l type -rf -a "exe lib" -d "Package type"
complete -c tada -n "__fish_seen_subcommand_from init" -s t -rf -a "exe lib" -d "Package type"
...
complete -c tada -n "__fish_seen_subcommand_from run" -l profile -rf -a "debug release" -d "Run profile"
complete -c tada -n "__fish_seen_subcommand_from run" -s p -rf -a "debug release" -d "Run profile"
...
complete -c tada -n "__fish_seen_subcommand_from test" -s p -rf -a "debug release" -d "Test profile"
