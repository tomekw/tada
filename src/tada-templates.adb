...
package body Tada.Templates is
   ...
   begin
      ...
      Put_Line (File, "   for Create_Missing_Dirs use ""True"";");
      Put_Line (File, "");
      ...
      Put_Line (File, "   Release_Switches := Common_Compiler_Switches & Style_Switches &");
      Put_Line (File, "     (""-O2"", ""-gnatn"", ""-fdata-sections"", ""-ffunction-sections"");");
      Put_Line (File, "   case Build_Profile is");
      Put_Line (File, "      when ""debug"" => Compiler_Switches := Debug_Switches;");
      Put_Line (File, "      when ""release"" => Compiler_Switches := Release_Switches;");
   ...
   begin
      ...
      case Kind is
         when Exe =>
            ...
            Put_Line (File, "      for Default_Switches (""Ada"") use " & MC & "_Config.Binder_Switches;");
            Put_Line (File, "   end Binder;");
            Put_Line (File, "");
            Put_Line (File, "   package Builder is");
            Put_Line (File, "      for Executable (""" & Name & "-main.adb"") use """ & Name & """;");
            Put_Line (File, "      for Default_Switches (""Ada"") use " & MC & "_Config.Builder_Switches;");
            Put_Line (File, "   end Builder;");
            Put_Line (File, "");
            Put_Line (File, "   package Compiler is");
            Put_Line (File, "      for Default_Switches (""Ada"") use " & MC & "_Config.Compiler_Switches;");
            Put_Line (File, "   end Compiler;");
            Put_Line (File, "");
            Put_Line (File, "   package Linker is");
            Put_Line (File, "      for Default_Switches (""Ada"") use " & MC & "_Config.Linker_Switches;");
