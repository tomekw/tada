...
package body Tada.Templates is
   ...
   procedure Write_Gitignore (File : File_Type) is
   begin
      Put_Line (File, "target/");
      Put_Line (File, "deps.gpr");
   end Write_Gitignore;
   ...
   procedure Write_GPR_Deps (File : File_Type) is
   begin
      Put_Line (File, "--  generated by tada, do not edit");
      Put_Line (File, "abstract project Deps is");
      Put_Line (File, "end Deps;");
   end Write_GPR_Deps;
